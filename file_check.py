...
class FileCopier:
    ...
    def selectSourceFolder(self): # Selects Source Folder
        self.sourceFileCheck = filedialog.askdirectory(initialdir = "C:/Users/techacademy/desktop", title = "Select source folder")
        self.sourceFolderName.set(self.sourceFileCheck)
        
    def destinationFolder(self): # Selects Destination Folder
        self.destFileCheck = filedialog.askdirectory(initialdir = "C:/Users/techacademy/desktop", title = "Select destination folder")
